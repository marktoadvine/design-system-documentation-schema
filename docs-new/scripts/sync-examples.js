 ...
 *
 * Scans all MDX content pages in docs/content/ for include directives of the form:
 *
...
// Two different roots: include directives reference repo-root-relative
// paths (e.g. "spec/examples/entries/button.yaml"), but the MDX pages being
// scanned live under docs/content/.
...
function parseDirective(line) {
  ...
  // comments in docs/content pages — MDX rejects HTML comments outright.
  let style = "html";
...
function main() {
  ...
  if (totalIncludes === 0) {
    ...
    console.error(
      "  ✗ No include directives found — docs/content/ is missing or empty.",
    );
    process.exit(1);
  }
