...
// Schema document, the same way upstream ships dsds.bundled.schema.json.
...
const outFile = path.join(rootDir, "schema/dsds.bundled.schema.json");
...
const bundle = {
  ...
  description: "Every schema file under schema/, collected into one document. Generated by scripts/v0.20/bundle.js - do not hand-edit.",
  $ref: "#/$defs/base",
  $defs: defs,
};
