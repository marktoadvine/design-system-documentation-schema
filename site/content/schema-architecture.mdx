...
description: "The full DSDS schema reference. It covers document structure, entity properties, document block types, and all shared models."
---
...
Custom relations are allowed but MUST be vendor-namespaced (ex: `acme.themes`).
