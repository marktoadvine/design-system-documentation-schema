...
The Design System Doc Spec (DSDS) is a JSON format for documenting design systems. It puts every piece of docs (components, tokens, themes, foundations, patterns) in a machine-readable shape.

<ds-callout title="Key idea:">

DSDS documents the *how and why* of your design system. It complements other standards like the [W3C Design Tokens Format](https://www.w3.org/community/reports/design-tokens/CG-FINAL-format-20251028/) that handles the *what*.
