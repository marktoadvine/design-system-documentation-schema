...
slug: index
description: "A machine-readable format for design system documentation, what it means for a document to conform to the spec, every rule the spec enforces, and what the schema deliberately doesn't have."
---
