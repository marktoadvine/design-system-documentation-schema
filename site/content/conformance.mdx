...
<ds-callout variant="warning" title="DSDS-01–DSDS-23 is a reset id space, not a continuation of pre-0.20.0's:">
...
| `DSDS-10` | A `same-as` item's `level`, when declared, must match its target's. |
