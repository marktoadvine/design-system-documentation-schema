...
*Generated from the v{{VERSION}} schemas by `scripts/extract-normative.mjs` — do not edit by hand. 192 statements: 88 MUST, 29 MUST NOT, 61 SHOULD, 2 SHOULD NOT, 12 MAY.*
...
- **MUST:** MUST be lowercase; dots permitted for namespacing (ex: 'com.acme.contract-tests'). <small>`common/criterion§criterionCheck.scheme.1`</small>
