...
Every entry kind shares one open base: `id`, `kind`, `name`, `description` (required), plus `purpose`, `metadata`, `related`, `extends`, `refs`, `sections`, `$extensions` (optional). See [Conformance](index.html#how-the-schema-is-organized) for how the schema itself is put together.
