...
**References:** [Section](sections-section.md#section), [Id](common-id.md#id), [Markdown](common-markdown.md#markdown), [list](common-ref.md#list), [list](common-example.md#list), [Extensions](common-extensions.md#extensions), [namespaced](common-id.md#namespaced), [Metadata](metadata-metadata.md#metadata), `#/$defs/freeformEntry`
