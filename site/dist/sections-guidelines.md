...
**References:** [Section](sections-section.md#section), [Id](common-id.md#id), [Markdown](common-markdown.md#markdown), [RequirementLevel](common-requirement-level.md#requirementlevel), [Example](common-example.md#example), [list](common-ref.md#list), [Extensions](common-extensions.md#extensions), [namespaced](common-id.md#namespaced), [Metadata](metadata-metadata.md#metadata), `#/$defs/freeformEntry`
